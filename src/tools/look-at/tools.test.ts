...
import { normalizeArgs, validateArgs, createLookAtTool } from "./tools"
...
describe("look-at tool", () => {
  ...
  describe("createLookAtTool error handling", () => {
  ...
  describe("createLookAtTool model passthrough", () => {
  ...
  describe("createLookAtTool sync prompt (race condition fix)", () => {
