...
export const SPEC_TEMPLATE = `# Guidance
...
- When specs already exist and spec changes are needed, trigger requirements-first-workflow to revise requirements/design/tasks before implementation
